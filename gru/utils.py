...
def load_data(filename="../reddit-comments-2015.csv", vocabulary_size=2000, min_sent_characters=0):
    ...
    vocab = sorted(list(word_freq.items()), key=lambda x: (x[1], x[0]), reverse=True)[:vocabulary_size-2]
